...
@Client.on_message(command(["", f"@{BOT_USERNAME}"]) & other_filters)
...
@Client.on_message(command(["", f"@{BOT_USERNAME}", "vskip"]) & other_filters)
@authorized_users_only
...
@Client.on_message(
    command(["", f"@{BOT_USERNAME}", "", f"@{BOT_USERNAME}", "vstop"])
    & other_filters
)
@authorized_users_only
